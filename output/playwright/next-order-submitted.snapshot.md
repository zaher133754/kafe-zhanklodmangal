      ...
      - generic [ref=e71]:
        - generic [ref=e72]:
          - button "Предыдущий слайд" [ref=e73]:
            - img [ref=e74]
          - button "Открыть Страница меню ЖанКлод Мангал 2" [ref=e146]:
            - img "Страница меню ЖанКлод Мангал 2" [ref=e147]
    ...
    - generic [ref=e110]:
      ...
      - generic "Социальные сети" [ref=e119]:
        ...
        - link "Instagram" [ref=e124] [cursor=pointer]:
          ...
          - img [ref=e125]
  - dialog "Сделать заказ" [ref=e148]:
    - button "Закрыть" [ref=e149]:
      - img [ref=e150]
    - heading "Сделать заказ" [level=2] [ref=e153]
    - generic [ref=e154]:
      - generic [ref=e155]:
        - text: Имя
        - textbox "Имя" [ref=e156]: Тест Lighthouse
      - generic [ref=e157]:
        - text: Телефон
        - textbox "Телефон" [ref=e158]: +7 900 000-00-00
      - generic [ref=e159]:
        - text: Тип заявки
        - combobox "Тип заявки" [ref=e160]:
          - option "Доставка" [selected]
          - option "Банкет"
          - option "Вопрос по меню"
      - generic [ref=e161]:
        - text: Комментарий
        - textbox "Комментарий" [ref=e162]: Проверка локальной формы
      - button "Отправить" [ref=e163] [cursor=pointer]:
        - img [ref=e164]
        - text: Отправить
      - status [ref=e167]: Заявка принята. Канал отправки подключается через переменные окружения.
  - alert [ref=e128]
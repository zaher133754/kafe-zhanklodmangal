      ...
      <div className="container-tilda text-center">
        <div className="premium-panel mx-auto max-w-[1080px] px-5 py-12 sm:px-10 sm:py-14 md:px-14 md:py-16">
          ...
          >
            ...
            <br />
            <em>До 5 км:</em> при заказе от 3 000 руб — бесплатно, до 3 000 руб —
            350 руб.
            <br />
            <em>От 5 до 20 км:</em> 450 руб (или бесплатно от 5 000 руб).
            <br />
            Дальше 20 км заказ можно уточнить по телефону.
          </div>
